...
/**
 * 生成表格Doc、并插入图片
 * Description: User: flycloud Date: 13-12-14 Time: 下午8:15
 */
public class WordDemo {
	public static void main(String[] args) throws IOException, DocumentException {
		...
		wordUtils.insertContext(
				...
				12, Font.NORMAL, Element.ALIGN_CENTER);
		...
		wordUtils.insertImg("http://news.nen.com.cn/images/lhbodybg1.jpg", Element.ALIGN_CENTER, 400, 400, 50, 50, 50,
				0);
